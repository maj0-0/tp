...
import seedu.address.model.group.exceptions.TaskNotFoundException;
 ...
 * as to ensure that the task with exactly the same characteristics will be removed.
 *
...
public class UniqueTaskList implements Iterable<Task> {
    ...
    /**
     * Returns the backing list as a modifiable {@code List}.
     */
